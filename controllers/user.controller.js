...
exports.updateCheckedStatus = async (req, res) => {
  ...
  try {
    const data = await User.findByIdAndUpdate(id, { checked: req.body.checked }, { new: true })
    ...
    // ✅ checked true bo'lsa → userga bitta message yuboramiz (2 tilda)
...
${inviteLink}
      ...
      await sendMessage(data.telegram_id, combinedMessage)
    }
